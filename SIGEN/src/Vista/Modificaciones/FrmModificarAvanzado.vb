Public Class FrmModificarAvanzado
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Else 'Si no hay ningún error
            ...
            'Se invoca la funcion que hereda avanzado de usuario, la cual modifica un usuario generico
            usuario.modificarUsuario(usuario.documento, pNombre, pApellido, sApellido, fNac, email, dCalle, dNumero, nacionalidad, _
                                       sexo, sNombre, CBool(dBis), dApartamento, foto)
            ...
            If nuevaContra And contraCorrecta Then
                usuario.modificarContrasenia(usuario.documento, txtContrasenia.Text)
            ...
            If lbxTelefono.Items.Count > 0 Then
                ...
                'la clase Usuario).
                usuario.modificarTelefono(usuario.documento, tel)
            ...
            If Not cmbInstituto.SelectedItem = "" And Not CChar(cmbInstituto.SelectedItem) = "N" Then
                ...
                instituto.modificarPertenece(usuario.documento)
            End If
            ...
            FrmPerfilAvanzado.usuario = Nothing
            FrmPerfilAvanzado.usuario = New Avanzado(usuario.documento)
    ...
    Private Sub FrmModificarAvanzado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If esIngles Then
