Public Class FrmAltaDeportista
    Public esIngles As Boolean = False
    Public nav = New Navegacion(Me)
    Public Sub cargarInstitutos()
        ...
        End If
    End Sub
    Private Sub FrmAltaDeportista_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.cargarInstitutos()
        'Sistema bilingüe
        If esIngles Then
            Me.Text = "Sign Up Sportmen"
    ...
    Private Sub btnRegistrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRegistrar.Click
        ...
        Else 'Si no hay ningún error
            'Manda los datos al siguiente formulario

            'Si el usuario ingresó algún telefono
            If lbxTelefono.Items.Count > 0 Then
                ...
                ReDim FrmAltaDeportistaDos.tel(lbxTelefono.Items.Count - 1)

                'Para cada telefono de la lista se lo pasa al array tel
                For i As Integer = 0 To lbxTelefono.Items.Count - 1
                    FrmAltaDeportistaDos.tel(i) = CInt(lbxTelefono.Items(i))
                Next
            End If
            ...
            If Not cmbInstituto.SelectedItem = "" And Not CChar(cmbInstituto.SelectedItem) = "N" Then
                ...
                FrmAltaDeportistaDos.instituto = instituto
                FrmAltaDeportistaDos.actualizarActividad()
            End If

            FrmAltaDeportistaDos.documento = documento
            FrmAltaDeportistaDos.dNumero = dNumero
            FrmAltaDeportistaDos.dApartamento = dApartamento
            FrmAltaDeportistaDos.dBis = dBis
            FrmAltaDeportistaDos.pNombre = pNombre
            FrmAltaDeportistaDos.sNombre = sNombre
            FrmAltaDeportistaDos.pApellido = pApellido
            FrmAltaDeportistaDos.sApellido = sApellido
            FrmAltaDeportistaDos.email = email
            FrmAltaDeportistaDos.foto = foto
            FrmAltaDeportistaDos.dCalle = dCalle
            FrmAltaDeportistaDos.nacionalidad = nacionalidad
            FrmAltaDeportistaDos.sexo = sexo
            FrmAltaDeportistaDos.contrasenia = contrasenia
            FrmAltaDeportistaDos.fNac = fNac



            FrmAltaDeportistaDos.esIngles = esIngles
            nav.siguiente(FrmAltaDeportistaDos)
            End If
    End Sub
