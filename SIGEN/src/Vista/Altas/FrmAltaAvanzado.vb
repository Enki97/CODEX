Public Class FrmAltaAvanzado
    ...
    Private Sub FrmAltaAvanzado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.cargarInstitutos()
        'Sistema bilingüe
        If esIngles Then
            Me.Text = "Sign Up Avanced User"
    ...
    Private Sub btnRegistrar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRegistrar.Click
        ...
        Else 'Si no hay ningún error
            ...
            'Se inicializa un usuario avanzado
            Dim registrar = New Avanzado()
            ...
            'Se registra el usaurio avanzado concretamente, agregando un número de funcionario (ver registrarAvanzado
            'de la clase Avanzado).
            registrar.registrarAvanzado(documento)
