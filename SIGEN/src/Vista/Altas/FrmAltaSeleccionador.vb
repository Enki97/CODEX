Public Class FrmAltaSeleccionador
    ...
    Public Sub cargarInstitutos()
        ...
        End If
    End Sub
    Private Sub FrmAltaSeleccionador_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.cargarInstitutos()

        'Sistema bilingüe
        If esIngles Then
            Me.Text = "Sign Up Selecter User"
    ...
    Private Sub btnRegistrar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRegistrar.Click
        ...
        Else 'Si no hay ningún error
            ...
            Dim registrar = New Seleccionador()
