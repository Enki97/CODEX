Public Class FrmPerfilSeleccionador
    ...
    Public Sub cargarPerfil()
        ...
        lblMostrarAcreditacion.Text = usuario.acreditacionSeleccionador
    ...
    Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
        FrmModificarSeleccionador.esIngles = esIngles
        FrmModificarSeleccionador.usuario = usuario
        nav.siguiente(FrmModificarSeleccionador)
    End Sub

    Private Sub FrmPerfilSeleccionador_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.cargarPerfil()
        'Sistema bilingüe
        If esIngles Then
            Me.Text = "Profile"
